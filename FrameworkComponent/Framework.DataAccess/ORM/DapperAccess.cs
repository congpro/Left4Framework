...
namespace Framework.DataAccess.ORM.Dapper
{
    public class DapperAccess:IDisposable
    {
        ...
        public DapperAccess(string Connectionconfig)
        {
            _connection = new SqlConnection(ConfigurationManager.ConnectionStrings[Connectionconfig].ConnectionString);
        }
