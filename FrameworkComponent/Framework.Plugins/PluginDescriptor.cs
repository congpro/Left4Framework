    ...
    public class PluginDescriptor:IComparable<PluginDescriptor>
    {
        ...
        public virtual T Instance<T>() where T : class, IPlugin
        {
            ...
            //{
                ...
                {
                    instance = ServiceLocator.Current.ContainerManager.ResolveUnregistered(PluginType) as T;
              //x      instance = EngineContext.Current.ContainerManager.ResolveUnregistered(PluginType) as T;
                    //xinstance = Activator.CreateInstance(PluginType) as T;
                }
            //}
